...
import transformProps, {
  TrafficLightsChartProps,
  TrafficLightsDatum,
} from '../src/TrafficLights/transformProps';
...
describe('TrafficLights', () => {
  ...
  describe('transformProps()', () => {
    it('should fallback and format time', () => {
      ...
      expect(transformed.trafficLights).toStrictEqual(1.2345);
      expect(transformed.trafficLightsFallback).not.toBeNull();
    ...
    it('should respect datasource d3 format', () => {
      ...
      expect(transformed.formatNumber(transformed.trafficLights)).toStrictEqual('1.23');
    });
  });
});
