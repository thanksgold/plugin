...
import { TrafficLightsProps, TrafficLightsStylesProps } from './types';
...
const Styles = styled.div<TrafficLightsStylesProps>`
...
export default class TrafficLights extends PureComponent<TrafficLightsProps> {
