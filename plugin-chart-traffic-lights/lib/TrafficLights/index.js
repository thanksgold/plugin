...
const metadata = new _core.ChartMetadata({
  description: '',
  name: (0, _core.t)('Traffic Lights with Trendline'),
  thumbnail: _thumbnail.default,
  useLegacyApi: true
});

class TrafficLightsChartPlugin extends _core.ChartPlugin {
  constructor() {
    super({
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('./TrafficLights'))),
      metadata,
...
exports.default = TrafficLightsChartPlugin;
