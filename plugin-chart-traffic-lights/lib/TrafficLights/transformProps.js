...
const formatPercentChange = (0, _core.getNumberFormatter)(_core.NumberFormats.PERCENT_SIGNED_1_POINT); // we trust both the x (time) and y (traffic lights) to be numeric
