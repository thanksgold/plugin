...
async function defineSharedModule(name, fetchModule) {
...
async function defineSharedModules(moduleMap) {
  return Promise.all(Object.entries(moduleMap).map(([name, fetchModule]) => {
