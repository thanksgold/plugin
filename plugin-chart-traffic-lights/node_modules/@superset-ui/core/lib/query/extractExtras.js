...
function extractExtras(formData) {
  ...
  if ((0, _QueryFormData.isDruidFormData)(formData) && !partialQueryObject.druid_time_origin) {
    ...
    partialQueryObject.granularity = partialQueryObject.granularity_sqla || formData.granularity || formData.granularity_sqla;
